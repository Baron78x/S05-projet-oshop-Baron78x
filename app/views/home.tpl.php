<section>
    <div class="container-fluid">
      ...
      <div class="row mx-0">
        ...
        <div class="col-lg-4">
            <div class="card border-0 text-center text-white"><img src="assets/images/categ1.jpeg"
                alt="Card image" class="card-img">
              <div class="card-img-overlay d-flex align-items-center">
                <div class="w-100">
                  <h2 class="display-4 mb-4">Détente</h2>
                  <a href="products_list.html" class="btn btn-link text-white">Se faire plaisir
